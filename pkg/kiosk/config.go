...
type Config struct {
	General struct {
		...
		WindowSize     string `yaml:"window-size" env:"KIOSK_WINDOW_SIZE" env-default:"1920x1080" env-description:"Size of chromium window"`
		StartMaximized bool   `yaml:"start-maximized" env:"KIOSK_START_MAXIMIZED" env-default:"true" env-description:"Wether or not to fullscreen the browser at start"`
	} `yaml:"general"`
	Target struct {
